...
if (footerBottom) {
    ...
    footerBottom.innerHTML = `&copy; ${currentYear} Gokul's Integrated Farming. All rights reserved. Made with ❤️ and organic care.`;
}
...
console.log('%c🌱 Welcome to Gokul\'s Integrated Farming! 🌱', 'color: #6b8e23; font-size: 20px; font-weight: bold;');
...
document.addEventListener('keydown', (e) => {
    ...
    if (konamiCode.join('') === konamiSequence.join('')) {
        ...
        alert('🌾 Secret organic power activated! 🌾');
    }
});
